...
class DocumentStatus(str, enum.Enum):
    ...
    PENDING_MODEL = "PENDING_MODEL"  # Doc is fine; required models not available on endpoint
...
class Document(TimestampMixin, Base):
    ...
    corrections: Mapped[list["ExtractionCorrection"]] = relationship(
        "ExtractionCorrection", back_populates="document", lazy="selectin"
    )
