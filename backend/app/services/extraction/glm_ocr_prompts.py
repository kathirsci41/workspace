...
1. po_reference = the value from the field labeled "Customer Order No." ONLY
2. The field labeled "Reference" contains a PERSON'S NAME — never put it in po_reference
3. sales_order_no starts with "1OTM" — do not confuse with dc_number which starts with "1DNT"
4. dispatch_to is the customer's delivery address or name (labeled "Delivery To")
""",
...
EXTRACTION_SCHEMAS = {
    ...
    "COMPANY_DC": {
        ...
        "po_reference":   "Customer Order No — customer's PO number (labeled 'Customer Order No.', NOT a person name)",
