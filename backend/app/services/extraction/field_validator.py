...
# Matches bare date strings (no letters) — these are never valid PO reference numbers.
# Catches: "30/01/2026", "01-30-2026", "30.01.2026", "2026-01-30"
# Does NOT catch PO numbers with letters like "IGKPO/106399/2526" or "1PTR2526000405"
...
def fix_po_reference(value: Optional[str]) -> Optional[str]:
    ...
    - Rejects bare date strings (e.g. "30/01/2026" — not a PO number)
    ...
    # Reject bare date strings — a PO reference number always contains letters or
    # a long digit sequence; a plain date like "30/01/2026" is never valid here.
    if _DATE_ONLY_RE.match(clean):
        logger.info(f"Rejected po_reference as date string: '{clean}'")
        return None
